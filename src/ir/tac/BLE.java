...
public class BLE extends TAC {
    ...
    public BLE(int id, Variable left, int right) {
        super(id);
        this.id = id;
        this.left = left;
        this.right = right;
    ...
    public BLE(int id, Variable left, BasicBlock right) {
        super(id);
        this.id = id;
        this.left = left;
    ...
    public BLE(int id, Variable left, BasicBlock trueBlock, BasicBlock falseBlock) {
        super(id);
        this.id = id;
        this.left = left;
