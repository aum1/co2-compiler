...
// Optimization ==============================================================
    ...
    private TACList deadCodeEliminationSingleBlock(TACList tacList, FileWriter file, Set<String> liveVariables) {
        ...
        while ((currInstructions.get(indexOfLast) instanceof Call)  || (currInstructions.get(indexOfLast).getDest() == null)){
            indexOfLast++;
        ...
        liveVariables.add(currInstructions.get(indexOfLast).getDest().getSymbol().token().lexeme());
